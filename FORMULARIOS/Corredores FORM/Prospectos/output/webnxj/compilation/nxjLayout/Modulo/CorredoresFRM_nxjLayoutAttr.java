...
public class
	CorredoresFRM_nxjLayoutAttr
	extends FormWidget
{

public CorredoresFRM_nxjLayoutAttr()
{
...
{
	widget.addAttribute("displaywidth","1204");
	widget.addAttribute("stylesheets","");
	widget.addAttribute("displayheight","714");
	widget.addAttribute("fieldheight","719");
	widget.addAttribute("fieldwidth","1204");
...
private void setAttrFor_div_vco_codigo__50(Widget widget)
{
}
...
private void setAttrFor_div_vco_nombre__50(Widget widget)
{
}
...
private void setAttrFor_div_vco_telefono2__50(Widget widget)
{
}
...
private void setAttrFor_div_vco_telefono1__50(Widget widget)
{
}
...
{
	widget.addAttribute("_id","view1:(Modulo.CorredoresDVW)box11.");
...
{
	widget.addAttribute("_id","view1:(Modulo.CorredoresDVW)box11:(Modulo.CorredoresDVW)image1.");
...
private void dodiv_view1__10(Widget div_view1__10)
    ...
    nxjLayout.Modulo.CorredoresDVW_nxjLayoutAttr view1__20 = new nxjLayout.Modulo.CorredoresDVW_nxjLayoutAttr();
        {
        ...
        if (div_RepeatingArea1__30 != null)
            ...
            if (RepeatingArea1__40 != null)
                ...
                if (div_FXGRID_50 != null)
                    {
                Widget div_vco_codigo__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vco_codigo_");
                if (div_vco_codigo__50 != null)
                    {
                    setAttrFor_div_vco_codigo__50(div_vco_codigo__50);
                    Widget vco_codigo__60 = ((ContainerWidget)div_vco_codigo__50).getComponent("vco_codigo_");
                    if (vco_codigo__60 != null)
                        {
                        setAttrFor_vco_codigo__60(vco_codigo__60);
                        }
                    }
                Widget div_vco_nombre__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vco_nombre_");
                if (div_vco_nombre__50 != null)
                    {
                    setAttrFor_div_vco_nombre__50(div_vco_nombre__50);
                    Widget vco_nombre__60 = ((ContainerWidget)div_vco_nombre__50).getComponent("vco_nombre_");
                    if (vco_nombre__60 != null)
                        {
                        setAttrFor_vco_nombre__60(vco_nombre__60);
                        }
                    }
                Widget div_vco_telefono2__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vco_telefono2_");
                if (div_vco_telefono2__50 != null)
                    {
                    setAttrFor_div_vco_telefono2__50(div_vco_telefono2__50);
                    Widget vco_telefono2__60 = ((ContainerWidget)div_vco_telefono2__50).getComponent("vco_telefono2_");
                    if (vco_telefono2__60 != null)
                        {
                        setAttrFor_vco_telefono2__60(vco_telefono2__60);
                        }
                    }
                Widget div_vco_telefono1__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vco_telefono1_");
                if (div_vco_telefono1__50 != null)
                    {
                    setAttrFor_div_vco_telefono1__50(div_vco_telefono1__50);
                    Widget vco_telefono1__60 = ((ContainerWidget)div_vco_telefono1__50).getComponent("vco_telefono1_");
                    if (vco_telefono1__60 != null)
                        {
                        setAttrFor_vco_telefono1__60(vco_telefono1__60);
                        }
                    }
                    div_FXGRID_50.addAttribute("id","view1_FXGRID");
                    div_FXGRID_50.addAttribute("jsinit","   var view1_RepeatingArea1__FXColumns = [new NXJGridColumn( 	'Codigo', 	'1', 	'1', 	'85', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_codigo', 'view1:vco_codigo.', '', ''), new NXJGridColumn( 	'Nombre', 	'1', 	'1', 	'251', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_nombre', 'view1:vco_nombre.', '', ''), new NXJGridColumn( 	'Telefono 2', 	'1', 	'1', 	'108', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_telefono2', 'view1:vco_telefono2.', '', ''), new NXJGridColumn( 	'Telefono 1', 	'1', 	'1', 	'108', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_telefono1', 'view1:vco_telefono1.', '', '') ]; ; if (!window.namesToComponents['view1_FXGRID'])     {     window.namesToComponents['view1_FXGRID'] = new NXJGrid('view1_FXGRID', view1_RepeatingArea1__FXColumns, 16, null, null, '__NXJ_CONTEXT_PATH__/unify', '', '', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/Otros FORMS/Prospectos/sources/Static_Content/');     } ");
                    }
                }
            }
