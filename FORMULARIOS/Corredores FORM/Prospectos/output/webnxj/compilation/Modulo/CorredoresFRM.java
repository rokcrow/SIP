...
public class CorredoresFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private CorredoresFRM CorredoresFRM = this;
    public class view1
	extends Modulo.CorredoresDVW
    {
    ...
    public CorredoresFRM(NXJSession session, NXJForm prevForm)
    {
	super("CorredoresFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected CorredoresFRM(String formName, NXJSession session, NXJForm prevForm)
    {
