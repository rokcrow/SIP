...
public class EmpresasFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private EmpresasFRM EmpresasFRM = this;
    public class view1
	extends Modulo.EmpresasDVW
    {
    ...
    public EmpresasFRM(NXJSession session, NXJForm prevForm)
    {
	super("EmpresasFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected EmpresasFRM(String formName, NXJSession session, NXJForm prevForm)
    {
    ...
    public static final String menuLabel = "EmpresasFRM";
} // EmpresasFRM
