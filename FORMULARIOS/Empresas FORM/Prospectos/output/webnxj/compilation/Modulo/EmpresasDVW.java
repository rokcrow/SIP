...
public class EmpresasDVW
    extends com.unify.nxj.mgr.NXJDataView
{

    public com.unify.nxj.mgr.NXJMasterRelationshipExpression[] us$getPUBLIC_xel_emprelogo_1_FindExpressions()
    {
	return new com.unify.nxj.mgr.NXJMasterRelationshipExpression[]
		    ...
		    throws Exception
		{
			...
			{
			new com.unify.nxj.mgr.datatypes.NXJSearchRange(com.unify.nxj.mgr.datatypes.NXJSearchRange.EqualOP, <form>.xem_codigo, null)
			};
		} // evaluate
	    }
	    };
    } // us$getPUBLIC_xel_emprelogo_1_FindExpressions

    public com.unify.nxj.mgr.NXJMasterAddExpression[] us$getPUBLIC_xel_emprelogo_1_AddExpressions()
    {
	return new com.unify.nxj.mgr.NXJMasterAddExpression[]
		...
		public Nullable evaluate()
		    throws Exception
		{
		    return <form>.xem_codigo;
		} // evaluate
	    }
	    };
    } // us$getPUBLIC_xel_emprelogo_1_AddExpressions
    private EmpresasDVW EmpresasDVW = this;
    ...
    public class PUBLIC_xel_emprelogo
	extends com.unify.nxj.mgr.NXJDataView
    {
	...
	public PUBLIC_xel_emprelogo(com.unify.nxj.mgr.NXJContainer container)
	{
	    super("PUBLIC_xel_emprelogo", container);
    ...
    } // PUBLIC_xel_emprelogo

    public final PUBLIC_xel_emprelogo PUBLIC_xel_emprelogo = new PUBLIC_xel_emprelogo(this);
    public class box11
	    ...
	    extends ItemsForm.Logo
	{
	    ...
	    public image1()
	    {
		super(Modulo.EmpresasDVW.box11.this, "image1", false);
	    } // <init>
	} // image1
	    ...
	    extends ItemsForm.TituloLBL
	{
	    ...
	    public label1()
	    {
		super(Modulo.EmpresasDVW.box111.this, "label1", false);
	    } // <init>
	} // label1
    ...
    public EmpresasDVW(String dataViewName, com.unify.nxj.mgr.NXJContainer container)
    {
	super(dataViewName, container);
	Modulo.EmpresasDVW.this.PUBLIC_xel_emprelogo.us$setMasterDataView(Modulo.EmpresasDVW.this);
	Modulo.EmpresasDVW.this.PUBLIC_xel_emprelogo.us$setMasterRelationshipCriteria(Modulo.EmpresasDVW.this.us$getPUBLIC_xel_emprelogo_1_FindExpressions());
	Modulo.EmpresasDVW.this.PUBLIC_xel_emprelogo.us$setMasterRelationshipAddExpr(Modulo.EmpresasDVW.this.us$getPUBLIC_xel_emprelogo_1_AddExpressions());
