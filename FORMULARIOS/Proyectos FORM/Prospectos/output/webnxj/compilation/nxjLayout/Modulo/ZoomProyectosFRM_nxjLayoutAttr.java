...
public class
	ZoomProyectosFRM_nxjLayoutAttr
	extends FormWidget
{

public ZoomProyectosFRM_nxjLayoutAttr()
{
...
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)RepeatingArea1.");
	widget.addAttribute("id","view1:RepeatingArea1.");
	widget.addStyle("overflow","hidden");
}

private void setAttrFor_div_vpy_codigo__50(Widget widget)
{
}
...
private void setAttrFor_vpy_codigo__60(Widget widget)
{
	...
	widget.addAttribute("headertitle","Codigo de Ventas");
	widget.addAttribute("_name","view1:(Modulo.ZoomProyectosDVW)vpy_codigo.");
	widget.addAttribute("name","view1:vpy_codigo.");
	widget.addStyle("overflow","hidden");
}

private void setAttrFor_div_vpy_empresa__50(Widget widget)
{
}
...
private void setAttrFor_vpy_empresa__60(Widget widget)
{
	...
	widget.addAttribute("headertitle","Ventas-Proyectos");
	widget.addAttribute("_name","view1:(Modulo.ZoomProyectosDVW)vpy_empresa.");
	widget.addAttribute("name","view1:vpy_empresa.");
	widget.addStyle("overflow","hidden");
}

private void setAttrFor_div_vpy_nombre__50(Widget widget)
{
}
...
private void setAttrFor_vpy_nombre__60(Widget widget)
{
	...
	widget.addAttribute("headertitle","Nombre de Ventas");
	widget.addAttribute("_name","view1:(Modulo.ZoomProyectosDVW)vpy_nombre.");
...
private void setAttrFor_textfield1__60(Widget widget)
{
	...
	widget.addAttribute("_name","view1:(Modulo.ZoomProyectosDVW)textfield1.");
	widget.addAttribute("name","view1:textfield1.");
	widget.addStyle("overflow","hidden");
}

private void setAttrFor_div_navigationbar1__50(Widget widget)
{
}

private void setAttrFor_navigationbar1__60(Widget widget)
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)navigationbar1.");
...
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)box11.");
...
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)box11:(Modulo.ZoomProyectosDVW)image1.");
...
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)box111.");
...
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)box111:(Modulo.ZoomProyectosDVW)label1.");
...
{
	widget.addAttribute("type","text");
	widget.addAttribute("_name","view1:(Modulo.ZoomProyectosDVW)box111:(Modulo.ZoomProyectosDVW)textfield1.");
...
{
	widget.addAttribute("type","text");
	widget.addAttribute("_name","view1:(Modulo.ZoomProyectosDVW)box111:(Modulo.ZoomProyectosDVW)textfield11.");
...
{
	widget.addAttribute("_id","view1:(Modulo.ZoomProyectosDVW)label11.");
...
private void dodiv_view1__10(Widget div_view1__10)
    ...
    nxjLayout.Modulo.ZoomProyectosDVW_nxjLayoutAttr view1__20 = new nxjLayout.Modulo.ZoomProyectosDVW_nxjLayoutAttr();
        {
        ...
        if (div_RepeatingArea1__30 != null)
            ...
            if (RepeatingArea1__40 != null)
                ...
                if (div_FXGRID_50 != null)
                    {
                Widget div_vpy_codigo__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vpy_codigo_");
                if (div_vpy_codigo__50 != null)
                    {
                    setAttrFor_div_vpy_codigo__50(div_vpy_codigo__50);
                    Widget vpy_codigo__60 = ((ContainerWidget)div_vpy_codigo__50).getComponent("vpy_codigo_");
                    if (vpy_codigo__60 != null)
                        {
                        setAttrFor_vpy_codigo__60(vpy_codigo__60);
                        }
                    }
                Widget div_vpy_empresa__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vpy_empresa_");
                if (div_vpy_empresa__50 != null)
                    {
                    setAttrFor_div_vpy_empresa__50(div_vpy_empresa__50);
                    Widget vpy_empresa__60 = ((ContainerWidget)div_vpy_empresa__50).getComponent("vpy_empresa_");
                    if (vpy_empresa__60 != null)
                        {
                        setAttrFor_vpy_empresa__60(vpy_empresa__60);
                        }
                    }
                Widget div_vpy_nombre__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_vpy_nombre_");
                if (div_vpy_nombre__50 != null)
                    {
                    setAttrFor_div_vpy_nombre__50(div_vpy_nombre__50);
                    Widget vpy_nombre__60 = ((ContainerWidget)div_vpy_nombre__50).getComponent("vpy_nombre_");
                    if (vpy_nombre__60 != null)
                        {
                        setAttrFor_vpy_nombre__60(vpy_nombre__60);
                        }
                    }
                Widget div_textfield1__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_textfield1_");
                if (div_textfield1__50 != null)
                    ...
                    div_FXGRID_50.addAttribute("jsinit","var combo3 = ['Temporal', 'Real'];    var view1_RepeatingArea1__FXColumns = [new NXJGridColumn( 	'Codigo de Ventas', 	'1', 	'1', 	'162', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vpy_codigo', 'view1:vpy_codigo.', '', ''), new NXJGridColumn( 	'Ventas-Proyectos', 	'1', 	'1', 	'163', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vpy_empresa', 'view1:vpy_empresa.', '', ''), new NXJGridColumn( 	'Nombre de Ventas', 	'1', 	'1', 	'161', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vpy_nombre', 'view1:vpy_nombre.', '', ''), new NXJGridColumn( 	'Column1', 	'3', 	'1', 	'160', 	'', 	combo3, 	'Temporal', 	'textfield', 	true, 	true, 	'', 'view1:textfield1.', '', '') ]; ; if (!window.namesToComponents['view1_FXGRID'])     {     window.namesToComponents['view1_FXGRID'] = new NXJGrid('view1_FXGRID', view1_RepeatingArea1__FXColumns, 22, null, null, '__NXJ_CONTEXT_PATH__/unify', '', '', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/Otros FORMS/Prospectos/sources/Static_Content/');     } ");
                    }
                Widget div_navigationbar1__50 = ((ContainerWidget)RepeatingArea1__40).getComponent("div_navigationbar1_");
                if (div_navigationbar1__50 != null)
                    {
                    setAttrFor_div_navigationbar1__50(div_navigationbar1__50);
                    Widget navigationbar1__60 = ((ContainerWidget)div_navigationbar1__50).getComponent("navigationbar1_");
                    if (navigationbar1__60 != null)
                        {
                        setAttrFor_navigationbar1__60(navigationbar1__60);
                        navigationbar1__60.addAttribute("zeroWidth",10);
                        navigationbar1__60.addAttribute("linkGap",38);
                        navigationbar1__60.addAttribute("prevWidth",76);
                        navigationbar1__60.addAttribute("nextWidth",42);
                        navigationbar1__60.addAttribute("prevTitle","Previous");
                        navigationbar1__60.addAttribute("nextTitle","Next");
                        navigationbar1__60.addAttribute("nlinks",2);
                        }
                    }
                }
            }
