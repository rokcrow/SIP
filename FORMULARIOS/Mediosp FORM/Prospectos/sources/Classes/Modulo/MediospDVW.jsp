...
<body onLoad="initPreview(false, -1, -1, 'file:///C:\Unify\NXJ/web-app/unify/images', 'file:///C:/Users/TI3-Provivienda/Desktop/Otros FORMS/Prospectos/sources/Static_Content');window.initInternalJavaScriptComponents();" class="form" >
    ...
    <form
        ...
        <div
            binary_variables=""
            view="div"
            style="position: absolute; top: 25px; left: 25px; width:1005px; height:684px">
            ...
            <div
                ...
                <div
                    binary_variables=""
                    view="div"
                    style="position: absolute; top: 83px; left: -128px; width:536px; height:464px">
                ...
                <div
                    binary_variables=""
                    view="div"
                    style="position: absolute; top: 629px; left: 4px; width:996px; height:50px">
