...
public class MenuDVW
    extends com.unify.nxj.mgr.NXJDataView
{
    private MenuDVW MenuDVW = this;
    public NullableStringField EMPRESA = new com.unify.nxj.mgr.datatypes.NXJStringField(this, "EMPRESA", false, true, 100);
	    ...
	    extends ItemsForm.Logo
	{
	    ...
	    public image1()
	    {
		super(Modulo.MenuDVW.box11.this, "image1", false);
	    } // <init>
	} // image1
	    ...
	    extends ItemsForm.TituloLBL
	{
	    ...
	    public label1()
	    {
		super(Modulo.MenuDVW.box111.this, "label1", false);
	    } // <init>
	} // label1
    ...
    public MenuDVW(String dataViewName, com.unify.nxj.mgr.NXJContainer container)
    {
	...
	EMPRESA.setStyleClass("listbox");
	EMPRESA.us$setView("select");
	EMPRESA.setRequired(false);
	EMPRESA.setFindable(false);
	EMPRESA.setStopForInput(true);
	...
	menuPri.setFontFamily("Calibri");
	menuPri.setFontSize("14");
	menuPri.us$setFontStyle("normal");
	menuPri.us$setFontWeight("bold");
	menuPri.us$setMenuContent("f\tMenubar\t\t<current>\t\t\tt\t0");
    } // <init>
} // MenuDVW
