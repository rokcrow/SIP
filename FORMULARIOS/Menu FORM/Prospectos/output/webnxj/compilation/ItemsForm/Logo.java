...
public class Logo
    extends com.unify.nxj.mgr.datatypes.NXJImageImpl
{
    private Logo Logo = this;

    public Logo(com.unify.nxj.mgr.NXJContainer container, String controlName, boolean isMultiValued)
    {
