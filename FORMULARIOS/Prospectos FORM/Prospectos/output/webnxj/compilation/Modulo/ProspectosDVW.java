    ...
    extends com.unify.nxj.mgr.NXJDataView
{
	...
	if (((us$R2 = (us$R1 = us$registerPool.allocateRegister().load(Var1.isNull())).isLogicalOrDecided() ? us$R1 : us$R1.logicalOrOp(us$registerPool.allocateRegister().load(Var1).eqOp(""))).isLogicalOrDecided() ? us$R2 : us$R2.logicalOrOp(us$registerPool.allocateRegister().load(Var1).eqOp(" "))).getBooleanValueNullOk())
	    {
	    ...
	    throws java.sql.SQLException, com.unify.nxj.mgr.dataConnection.NXJDataConnectionException
	{
		...
		try
		    {
		    us$stmt3 = us$conn3.prepareStatement("select vpy_nombre from vpy_proyectos order by vpy_nombre");
	    ...
	    throws Exception
	{
		...
		vpp_actitiempo.setNextField("vpp_actilugar");
	    else
		vpp_actitiempo.setNextField("vpp_ingreso");
	} // onDataAccept
	    ...
	    throws Exception
	{
		...
		try
		    {
		    us$stmt4 = us$conn4.prepareStatement("SELECT xpc_nombre, xpc_califica, xpc_dias_pac, xpc_dias_pvt FROM xpc_proscalif WHERE xpc_codigo =  ?");
		    vpp_califica.us$setSqlParameterValue(us$stmt4, 1);
		    us$rs4 = us$stmt4.executeQuery();
		    int us$rowsTouched4 = 0;
		    try
			{
			java.sql.ResultSetMetaData us$rsmd4 = us$rs4.getMetaData();
			if (us$rsmd4.getColumnCount() != 4)
			    throw new SQLException(getSession().us$getMessage("EXPECTED_VS_ACTUAL_COLUMN_COUNT", new Object[]
				{
				Integer.toString(us$rsmd4.getColumnCount()), "4"
				}));
			com.unify.nxj.mgr.dataConnection.NXJDataIterator us$getter4 = us$conn4.createDataIterator(us$rs4);
			if (us$getter4.next())
			    {
			    ++us$rowsTouched4;
			    us$getter4.assignValueToVariable(xpc_nombre, 1);
			    us$getter4.assignValueToVariable(xpc_califica, 2);
			    us$getter4.assignValueToVariable(xpc_dias_pac, 3);
			    us$getter4.assignValueToVariable(xpc_dias_pvt, 4);
			    }
			}
		    finally
			{
	    ...
	    throws Exception
	{
		...
		try
		    {
		    us$stmt5 = us$conn5.prepareStatement("SELECT xpc_nombre, xpc_califica, xpc_dias_pac, xpc_dias_pvt FROM xpc_proscalif WHERE xpc_codigo =  ?");
		    vpp_califica.us$setSqlParameterValue(us$stmt5, 1);
		    us$rs5 = us$stmt5.executeQuery();
		    int us$rowsTouched5 = 0;
		    try
			{
			java.sql.ResultSetMetaData us$rsmd5 = us$rs5.getMetaData();
			if (us$rsmd5.getColumnCount() != 4)
			    throw new SQLException(getSession().us$getMessage("EXPECTED_VS_ACTUAL_COLUMN_COUNT", new Object[]
				{
				Integer.toString(us$rsmd5.getColumnCount()), "4"
				}));
			com.unify.nxj.mgr.dataConnection.NXJDataIterator us$getter5 = us$conn5.createDataIterator(us$rs5);
			if (us$getter5.next())
			    {
			    ++us$rowsTouched5;
			    us$getter5.assignValueToVariable(xpc_nombre, 1);
			    us$getter5.assignValueToVariable(xpc_califica, 2);
			    us$getter5.assignValueToVariable(xpc_dias_pac, 3);
			    us$getter5.assignValueToVariable(xpc_dias_pvt, 4);
			    }
			}
		    finally
			{
	    ...
	    throws java.sql.SQLException, com.unify.nxj.mgr.dataConnection.NXJDataConnectionException
	{
		...
		try
		    {
		    us$stmt6 = us$conn6.prepareStatement("select xpa_nombre from xpa_paises");
			...
			while (us$getter6.next())
			    {
			    ++us$rowsTouched6;
			    us$proj1 = us$getter6.getString(1);
	    ...
	    throws Exception
	{
		...
		try
			...
			if (us$getter7.next())
			    {
			    ++us$rowsTouched7;
			    us$getter7.assignValueToVariable(vpp_corredor, 1);
			    }
			}
		    finally
			{
	    ...
	    throws Exception
	{
		...
		try
			...
			if (us$getter8.next())
			    {
			    ++us$rowsTouched8;
			    us$getter8.assignValueToVariable(vpp_corredor, 1);
			    }
			}
		    finally
			{
	...
	public vpp_corredor()
	{
	    ...
	    setUpdateable(true);
	    setCaseConversion(NullableField.CaseConversion_UPPER);
	    setZoomFormName("parametros/corredores");
	    setZoomEnabled(true);
	    setForegroundColor("Black");
	    setFontSize("12");
	    us$executesDataAcceptValueChanges = true;
	    ...
	    throws java.sql.SQLException, com.unify.nxj.mgr.dataConnection.NXJDataConnectionException
	{
		...
		try
		    {
		    us$stmt9 = us$conn9.prepareStatement("select xzo_nombre from xzo_zonas");
	    ...
	    throws Exception
	{
		...
		try
		    {
		    us$stmt10 = us$conn10.prepareStatement("SELECT vmp_descripcion FROM vmp_mediosp WHERE vmp_codigo =  ?");
		    vpp_mediopub.us$setSqlParameterValue(us$stmt10, 1);
			...
			if (us$getter10.next())
			    {
			    ++us$rowsTouched10;
			    us$getter10.assignValueToVariable(vmp_descripcion, 1);
			    }
			}
		    finally
			{
	    ...
	    throws Exception
	{
		...
		try
		    {
		    us$stmt11 = us$conn11.prepareStatement("SELECT vmp_descripcion FROM vmp_mediosp WHERE vmp_codigo =  ?");
		    vpp_mediopub.us$setSqlParameterValue(us$stmt11, 1);
			...
			if (us$getter11.next())
			    {
			    ++us$rowsTouched11;
			    us$getter11.assignValueToVariable(vmp_descripcion, 1);
			    }
			}
		    finally
			{
	    ...
	    throws java.sql.SQLException, com.unify.nxj.mgr.dataConnection.NXJDataConnectionException
	{
		...
		try
		    {
		    us$stmt12 = us$conn12.prepareStatement("select xpa_nombre from xpa_paises");
			...
			while (us$getter12.next())
			    {
			    ++us$rowsTouched12;
			    us$proj1 = us$getter12.getString(1);
	    ...
	    throws Exception
	{
		...
		try
		    {
		    us$stmt13 = us$conn13.prepareStatement("SELECT vve_nombre FROM vve_vendedora WHERE vve_codigo =  ?");
		    vpp_vendedor.us$setSqlParameterValue(us$stmt13, 1);
			...
			if (us$getter13.next())
			    {
			    ++us$rowsTouched13;
			    us$getter13.assignValueToVariable(vve_nombre, 1);
			    }
			}
		    finally
			{
	    ...
	    throws Exception
	{
		...
		try
		    {
		    us$stmt14 = us$conn14.prepareStatement("SELECT vco_nombre FROM vco_corredores WHERE vco_codigo =  ?");
		    vpp_corredor.us$setSqlParameterValue(us$stmt14, 1);
			...
			if (us$getter14.next())
			    {
			    ++us$rowsTouched14;
			    us$getter14.assignValueToVariable(vco_nombre, 1);
			    }
			}
		    finally
			{
	...
	public vpp_vendedor()
	{
	    ...
	    setUpdateable(true);
	    setCaseConversion(NullableField.CaseConversion_UPPER);
	    setZoomFormName("parametros/vendedor");
	    setZoomEnabled(true);
