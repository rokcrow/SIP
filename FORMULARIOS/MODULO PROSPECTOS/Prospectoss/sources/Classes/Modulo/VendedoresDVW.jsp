...
<body onLoad="initPreview(false, -1, -1, 'file:///C:\Unify\NXJ/web-app/unify/images', 'file:///C:/Users/TI3-Provivienda/Desktop/VENTAS- PROSPECTOS/MODULO PROSPECTOS/Prospectoss/sources/Static_Content');window.initInternalJavaScriptComponents();" class="form" >
    ...
    <form
        ...
        <div
            binary_variables=""
            view="div"
            style="position: absolute; top: 25px; left: 25px; width:1005px; height:466px">
            ...
            <div
                ...
                <div
                    binary_variables=""
                    view="div"
                    style="position: absolute; top: -122px; left: 75px; width:476px; height:302px">
                ...
                <div
                    binary_variables=""
                    view="div"
                    style="position: absolute; top: 411px; left: 4px; width:996px; height:50px">
                    ...
                    <fieldset
                        ...
                        <div
                            ...
                            <input
                                ...
                                name=".top:cajaarribaVendedores:actualempresa."
                        ...
                        <div
                            ...
                            <input
                                ...
                                name=".top:cajaarribaVendedores:actualusuario."
                                original_name="textfield1"
                                size="18"
                                stop_for_input="false"
                                target_field=""
                        ...
                        <div
                            ...
                            <label
                                ...
                                displaytop="65"
                                displaywidth="55"
                                id=".top:cajaarribaVendedores:label211."
