...
DivPanelWidget div_cajaarribaMPublicitarios__10 = new DivPanelWidget();
dodiv_cajaarribaMPublicitarios__10(div_cajaarribaMPublicitarios__10);
...
private void setAttrFor_div_cajaarribaMPublicitarios__10(Widget widget)
{
	widget.addStyle("left","4px");
	widget.addStyle("top","2px");
	widget.addStyle("width","996px");
...
private void setAttrFor_cajaarribaMPublicitarios__20(Widget widget)
{
	widget.addAttribute("field_weight","99");
	widget.addAttribute("displaywidth","996");
	widget.addStyle("border-width","0");
	widget.addAttribute("id",".top:cajaarribaMPublicitarios.");
	widget.addAttribute("displayleft","4");
	widget.addStyle("border-style","None");
	widget.addAttribute("displaytop","2");
	widget.setClass("box");
...
private void setAttrFor_actualempresa__40(Widget widget)
{
	...
	widget.addAttribute("name",".top:cajaarribaMPublicitarios:actualempresa.");
	widget.addStyle("overflow","hidden");
}
...
private void setAttrFor_actualusuario__40(Widget widget)
{
	...
	widget.addAttribute("name",".top:cajaarribaMPublicitarios:actualusuario.");
	widget.addStyle("overflow","hidden");
}
...
private void setAttrFor_label1__40(Widget widget)
{
	...
	widget.addAttribute("id",".top:cajaarribaMPublicitarios:label1.");
...
private void setAttrFor_label211__40(Widget widget)
{
	...
	widget.addAttribute("id",".top:cajaarribaMPublicitarios:label211.");
...
private void dodiv_cajaarribaMPublicitarios__10(Widget div_cajaarribaMPublicitarios__10)
    {
    ((ContainerWidget)this).addComponent(div_cajaarribaMPublicitarios__10,"div_cajaarribaMPublicitarios_");
    setAttrFor_div_cajaarribaMPublicitarios__10(div_cajaarribaMPublicitarios__10);
    FieldSetWidget cajaarribaMPublicitarios__20 = new FieldSetWidget();
        {
        ((ContainerWidget)div_cajaarribaMPublicitarios__10).addComponent(cajaarribaMPublicitarios__20,"cajaarribaMPublicitarios_");
        setAttrFor_cajaarribaMPublicitarios__20(cajaarribaMPublicitarios__20);
        DivPanelWidget div_actualempresa__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajaarribaMPublicitarios__20).addComponent(div_actualempresa__30,"div_actualempresa_");
        ...
        DivPanelWidget div_actualusuario__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajaarribaMPublicitarios__20).addComponent(div_actualusuario__30,"div_actualusuario_");
        ...
        DivPanelWidget div_label1__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajaarribaMPublicitarios__20).addComponent(div_label1__30,"div_label1_");
        ...
        DivPanelWidget div_label211__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajaarribaMPublicitarios__20).addComponent(div_label211__30,"div_label211_");
