...
public class
	SociedadesFRM_nxjLayoutAttr
	extends FormWidget
{

public SociedadesFRM_nxjLayoutAttr()
{
this.isLocalized = false;
setAttrFor_this(this);
DivPanelWidget div_cajagrandeSociedades__10 = new DivPanelWidget();
dodiv_cajagrandeSociedades__10(div_cajagrandeSociedades__10);
}
...
private void setAttrFor_div_cajagrandeSociedades__10(Widget widget)
{
	...
	widget.addStyle("height","714px");
}

private void setAttrFor_cajagrandeSociedades__20(Widget widget)
{
...
private void setAttrFor_div_PUBLIC_xel_emprelogo1__30(Widget widget)
{
	widget.addStyle("left","302px");
	widget.addStyle("top","441px");
	widget.addStyle("width","407px");
	widget.addStyle("height","154px");
}

private void setAttrFor_PUBLIC_xel_emprelogo1__40(Widget widget)
{
...
{
	widget.addStyle("left","123px");
	widget.addStyle("top","44px");
	widget.addStyle("width","255px");
	widget.addStyle("height","33px");
}
...
private void setAttrFor_div_chooser1__50(Widget widget)
{
	widget.addStyle("left","66px");
	widget.addStyle("top","114px");
	widget.addStyle("width","234px");
	widget.addStyle("height","27px");
}

private void setAttrFor_chooser1__60(Widget widget)
{
...
private void setAttrFor_div_label3__50(Widget widget)
{
	widget.addStyle("left","36px");
...
private void setAttrFor_div_label31__50(Widget widget)
{
	widget.addStyle("left","139px");
	widget.addStyle("top","20px");
...
private void setAttrFor_div_xel_codigo__50(Widget widget)
{
	widget.addStyle("left","36px");
	widget.addStyle("top","44px");
...
private void setAttrFor_xel_codigo__60(Widget widget)
{
	widget.addAttribute("field_weight","99");
...
{
	widget.addStyle("left","350px");
	widget.addStyle("top","127px");
	widget.addStyle("width","302px");
	widget.addStyle("height","245px");
}
...
private void setAttrFor_RepeatingArea1__40(Widget widget)
{
	...
	widget.addAttribute("fieldwidth","302");
	widget.addStyle("overflow","hidden");
}

private void setAttrFor_div_xem_codigo__50(Widget widget)
{
	widget.addStyle("display","none");
}

private void setAttrFor_xem_codigo__60(Widget widget)
{
	widget.addAttribute("field_weight","99");
...
private void setAttrFor_div_xem_nombre__50(Widget widget)
{
	widget.addStyle("display","none");
}

private void setAttrFor_xem_nombre__60(Widget widget)
{
	widget.addAttribute("field_weight","199");
	widget.addAttribute("accell_type","String");
	widget.addAttribute("field_type","text");
...
private void dodiv_cajagrandeSociedades__10(Widget div_cajagrandeSociedades__10)
    {
    ((ContainerWidget)this).addComponent(div_cajagrandeSociedades__10,"div_cajagrandeSociedades_");
    setAttrFor_div_cajagrandeSociedades__10(div_cajagrandeSociedades__10);
    FieldSetWidget cajagrandeSociedades__20 = new FieldSetWidget();
        {
        ((ContainerWidget)div_cajagrandeSociedades__10).addComponent(cajagrandeSociedades__20,"cajagrandeSociedades_");
        setAttrFor_cajagrandeSociedades__20(cajagrandeSociedades__20);
        DivPanelWidget div_PUBLIC_xel_emprelogo1__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajagrandeSociedades__20).addComponent(div_PUBLIC_xel_emprelogo1__30,"div_PUBLIC_xel_emprelogo1_");
            setAttrFor_div_PUBLIC_xel_emprelogo1__30(div_PUBLIC_xel_emprelogo1__30);
            DataViewWidget PUBLIC_xel_emprelogo1__40 = new DataViewWidget();
                {
                ((ContainerWidget)div_PUBLIC_xel_emprelogo1__30).addComponent(PUBLIC_xel_emprelogo1__40,"PUBLIC_xel_emprelogo1_");
                setAttrFor_PUBLIC_xel_emprelogo1__40(PUBLIC_xel_emprelogo1__40);
                DivPanelWidget div_Image1__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)PUBLIC_xel_emprelogo1__40).addComponent(div_Image1__50,"div_Image1_");
                    setAttrFor_div_Image1__50(div_Image1__50);
                    ImageWidget Image1__60 = new ImageWidget();
                        {
                        ((ContainerWidget)div_Image1__50).addComponent(Image1__60,"Image1_");
                        setAttrFor_Image1__60(Image1__60);
                        }
                    }
                DivPanelWidget div_chooser1__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)PUBLIC_xel_emprelogo1__40).addComponent(div_chooser1__50,"div_chooser1_");
                    setAttrFor_div_chooser1__50(div_chooser1__50);
                    FileChooserWidget chooser1__60 = new FileChooserWidget();
                        {
                        ((ContainerWidget)div_chooser1__50).addComponent(chooser1__60,"chooser1_");
                        setAttrFor_chooser1__60(chooser1__60);
                        }
                    }
                DivPanelWidget div_label3__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)PUBLIC_xel_emprelogo1__40).addComponent(div_label3__50,"div_label3_");
                    setAttrFor_div_label3__50(div_label3__50);
                    LabelWidget label3__60 = new LabelWidget();
                        {
                        ((ContainerWidget)div_label3__50).addComponent(label3__60,"label3_");
                        setAttrFor_label3__60(label3__60);
                        }
                    }
                DivPanelWidget div_label31__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)PUBLIC_xel_emprelogo1__40).addComponent(div_label31__50,"div_label31_");
                    setAttrFor_div_label31__50(div_label31__50);
                    LabelWidget label31__60 = new LabelWidget();
                        {
                        ((ContainerWidget)div_label31__50).addComponent(label31__60,"label31_");
                        setAttrFor_label31__60(label31__60);
                        }
                    }
                DivPanelWidget div_xel_codigo__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)PUBLIC_xel_emprelogo1__40).addComponent(div_xel_codigo__50,"div_xel_codigo_");
                    setAttrFor_div_xel_codigo__50(div_xel_codigo__50);
                    TextWidget xel_codigo__60 = new TextWidget();
                        {
                        ((ContainerWidget)div_xel_codigo__50).addComponent(xel_codigo__60,"xel_codigo_");
                        setAttrFor_xel_codigo__60(xel_codigo__60);
                        }
                    }
                }
            }
        DivPanelWidget div_RepeatingArea1__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajagrandeSociedades__20).addComponent(div_RepeatingArea1__30,"div_RepeatingArea1_");
            ...
            RepeatingAreaWidget RepeatingArea1__40 = new RepeatingAreaWidget();
                ...
                DivPanelWidget div_xem_codigo__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)RepeatingArea1__40).addComponent(div_xem_codigo__50,"div_xem_codigo_");
                    setAttrFor_div_xem_codigo__50(div_xem_codigo__50);
                    TextWidget xem_codigo__60 = new TextWidget();
                        {
                        ((ContainerWidget)div_xem_codigo__50).addComponent(xem_codigo__60,"xem_codigo_");
                        setAttrFor_xem_codigo__60(xem_codigo__60);
                        }
                    }
                DivPanelWidget div_xem_nombre__50 = new DivPanelWidget();
                    {
                    ((ContainerWidget)RepeatingArea1__40).addComponent(div_xem_nombre__50,"div_xem_nombre_");
                    setAttrFor_div_xem_nombre__50(div_xem_nombre__50);
                    TextWidget xem_nombre__60 = new TextWidget();
                        {
                        ((ContainerWidget)div_xem_nombre__50).addComponent(xem_nombre__60,"xem_nombre_");
                        setAttrFor_xem_nombre__60(xem_nombre__60);
                        }
                    }
                    div_FXGRID_50.addAttribute("id","SociedadesFRM_FXGRID");
                    div_FXGRID_50.addStyle("top","0");
                    div_FXGRID_50.addStyle("left","0");
                    div_FXGRID_50.addStyle("width","302");
                    div_FXGRID_50.addStyle("height","245");
                    ...
                    div_FXGRID_50.addAttribute("jsinit","   var cajagrandeSociedades_RepeatingArea1__FXColumns = [new NXJGridColumn( 	'Codigo', 	'1', 	'1', 	'57', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'xem_codigo', 'cajagrandeSociedades:xem_codigo.', '', ''), new NXJGridColumn( 	'Nombre', 	'1', 	'1', 	'226', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'xem_nombre', 'cajagrandeSociedades:xem_nombre.', '', '') ]; ; if (!window.namesToComponents['SociedadesFRM_FXGRID'])     {     window.namesToComponents['SociedadesFRM_FXGRID'] = new NXJGrid('SociedadesFRM_FXGRID', cajagrandeSociedades_RepeatingArea1__FXColumns, 16, null, null, '__NXJ_CONTEXT_PATH__/unify', '', '', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/VENTAS- PROSPECTOS/MODULO PROSPECTOS/Prospectoss/sources/Static_Content/');     } ");
                    }
                }
            }
        DivPanelWidget div_box11__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajagrandeSociedades__20).addComponent(div_box11__30,"div_box11_");
        ...
        DivPanelWidget div_label11__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajagrandeSociedades__20).addComponent(div_label11__30,"div_label11_");
