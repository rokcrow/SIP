...
public class ProyectosFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private ProyectosFRM ProyectosFRM = this;
    public class view1
	extends Modulo.ProyectosDVW
    {
    ...
    public ProyectosFRM(NXJSession session, NXJForm prevForm)
    {
	super("ProyectosFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected ProyectosFRM(String formName, NXJSession session, NXJForm prevForm)
    {
	...
	setZoomReturnExpressions(new NXJZoomReturnExpressions()
	{
		...
		return new com.unify.nxj.mgr.datatypes.Register[]
		    {
		    us$registerPool.allocateRegister().load(view1.vpy_codigo)
		    };
	    } // evaluate
    ...
    public static final String menuLabel = "ProyectosFRM";
} // ProyectosFRM
