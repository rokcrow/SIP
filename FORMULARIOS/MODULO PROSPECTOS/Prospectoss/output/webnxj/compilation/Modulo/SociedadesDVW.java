...
public class SociedadesDVW
    extends com.unify.nxj.mgr.NXJDataView
{
    private SociedadesDVW SociedadesDVW = this;
	    ...
	    extends ItemsForm.Logo
	{
	    ...
	    public image1()
	    {
		super(Modulo.SociedadesDVW.box11.this, "image1", false);
	    } // <init>
	} // image1
	    ...
	    extends ItemsForm.TituloLBL
	{
	    ...
	    public label1()
	    {
		super(Modulo.SociedadesDVW.box111.this, "label1", false);
	    } // <init>
	} // label1
    ...
    public SociedadesDVW(String dataViewName, com.unify.nxj.mgr.NXJContainer container)
    {
