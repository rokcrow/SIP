...
public class
	ZoomProyectosDVW_nxjLayoutAttr
	extends DataViewWidget
{

public ZoomProyectosDVW_nxjLayoutAttr()
{
...
{
	widget.addAttribute("list_columns",".top:vpy_codigo.0:162;.top:vpy_empresa.162:163;.top:vpy_nombre.325:161;.top:textfield1.486:160");
...
private void dodiv_RepeatingArea1__10(Widget div_RepeatingArea1__10)
    ...
    RepeatingAreaWidget RepeatingArea1__20 = new RepeatingAreaWidget();
        ...
        DivPanelWidget div_textfield1__30 = new DivPanelWidget();
            {
            ((ContainerWidget)RepeatingArea1__20).addComponent(div_textfield1__30,"div_textfield1_");
            setAttrFor_div_textfield1__30(div_textfield1__30);
            ListWidget textfield1__40 = new ListWidget();
                {
                ((ContainerWidget)div_textfield1__30).addComponent(textfield1__40,"textfield1_");
                setAttrFor_textfield1__40(textfield1__40);
                }
            }
            div_FXGRID_30.addAttribute("id","ZoomProyectosDVW_FXGRID");
            ...
            div_FXGRID_30.addAttribute("jsinit","var combo3 = ['Temporal', 'Real'];    var _top_RepeatingArea1__FXColumns = [new NXJGridColumn( 	'Codigo de Ventas', 	'1', 	'1', 	'162', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vpy_codigo', '.top:vpy_codigo.', '', ''), new NXJGridColumn( 	'Ventas-Proyectos', 	'1', 	'1', 	'163', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vpy_empresa', '.top:vpy_empresa.', '', ''), new NXJGridColumn( 	'Nombre de Ventas', 	'1', 	'1', 	'161', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vpy_nombre', '.top:vpy_nombre.', '', ''), new NXJGridColumn( 	'Column1', 	'3', 	'1', 	'160', 	'', 	combo3, 	'Temporal', 	'textfield', 	true, 	true, 	'', '.top:textfield1.', '', '') ]; ; if (!window.namesToComponents['ZoomProyectosDVW_FXGRID'])     {     window.namesToComponents['ZoomProyectosDVW_FXGRID'] = new NXJGrid('ZoomProyectosDVW_FXGRID', _top_RepeatingArea1__FXColumns, 22, null, null, '__NXJ_CONTEXT_PATH__/unify', '', '', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/Otros FORMS/Prospectos/sources/Static_Content/');     } ");
            }
