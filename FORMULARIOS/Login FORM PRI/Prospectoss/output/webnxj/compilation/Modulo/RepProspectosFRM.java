...
public class RepProspectosFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private RepProspectosFRM RepProspectosFRM = this;
    public class view1
	extends Modulo.RepProspectosDVW
    {
    ...
    public RepProspectosFRM(NXJSession session, NXJForm prevForm)
    {
	super("RepProspectosFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected RepProspectosFRM(String formName, NXJSession session, NXJForm prevForm)
    {
