...
public class GradoInteresFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private GradoInteresFRM GradoInteresFRM = this;
    public class view1
	extends Modulo.GradoInteresDVW
    {
    ...
    public GradoInteresFRM(NXJSession session, NXJForm prevForm)
    {
	super("GradoInteresFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected GradoInteresFRM(String formName, NXJSession session, NXJForm prevForm)
    {
	...
	setZoomReturnExpressions(new NXJZoomReturnExpressions()
	{
		...
		return new com.unify.nxj.mgr.datatypes.Register[]
		    {
		    us$registerPool.allocateRegister().load(view1.xpc_codigo)
		    };
	    } // evaluate
    ...
    public static final String menuLabel = "GradoInteresFRM";
} // GradoInteresFRM
