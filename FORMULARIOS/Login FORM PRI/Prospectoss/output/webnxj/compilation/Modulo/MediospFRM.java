...
public class MediospFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private MediospFRM MediospFRM = this;
    public class view1
	extends Modulo.MediospDVW
    {
    ...
    public MediospFRM(NXJSession session, NXJForm prevForm)
    {
	super("MediospFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected MediospFRM(String formName, NXJSession session, NXJForm prevForm)
    {
	...
	setZoomReturnExpressions(new NXJZoomReturnExpressions()
	{
		...
		return new com.unify.nxj.mgr.datatypes.Register[]
		    {
		    us$registerPool.allocateRegister().load(view1.vmp_codigo)
		    };
	    } // evaluate
    ...
    public static final String menuLabel = "MediospFRM";
} // MediospFRM
