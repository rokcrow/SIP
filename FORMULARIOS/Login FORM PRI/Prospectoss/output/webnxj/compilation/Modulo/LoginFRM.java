    ...
    extends com.unify.nxj.mgr.NXJForm
{
	    ...
	    extends com.unify.nxj.mgr.datatypes.NXJStringField
	{
	    ...
	    public xpr_usuario()
	    {
		super(Modulo.LoginFRM.cajagrandeLogin.this, "xpr_usuario", false, true, 100);
	    ...
	    extends com.unify.nxj.mgr.NXJBox
	{
		...
		public image1()
		{
		    super(Modulo.LoginFRM.cajagrandeLogin.cajaabajoLogin.this, "image1", false);
		} // <init>
	    } // image1
	    ...
	    extends com.unify.nxj.mgr.NXJBox
	{
		...
		public label1()
		{
		    super(Modulo.LoginFRM.cajagrandeLogin.cajaarribaLogin.this, "label1", false);
		} // <init>
	    } // label1
	...
	public logincmd()
	{
	    super("logincmd", Modulo.LoginFRM.this, 3, true, 1);
	    us$addCommand(this);
	} // <init>
    ...
    public LoginFRM(NXJSession session, NXJForm prevForm)
    {
	super("LoginFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected LoginFRM(String formName, NXJSession session, NXJForm prevForm)
    {
    ...
    public static final String menuLabel = "LoginFRM";
	...
	{
	    super(Modulo.LoginFRM.this, fld, multiValued);
	} // <init>

	protected Nullable getValue()
	    throws IllegalAccessException
	{
	    return (Nullable)fld.get(Modulo.LoginFRM.this);
	} // getValue

	protected void setValue(Nullable newValue)
	    throws IllegalAccessException
	{
	    fld.set(Modulo.LoginFRM.this, newValue);
	} // setValue
