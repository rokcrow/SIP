...
private void setAttrFor_box111__40(Widget widget)
{
	widget.addAttribute("field_weight","99");
	widget.addAttribute("displaywidth","996");
	widget.addAttribute("id","CajaSegui:box111.");
	widget.addStyle("border-width","0");
	widget.addAttribute("displayleft","4");
	widget.addStyle("border-style","None");
	widget.addStyle("background-color","#e30000");
...
private void setAttrFor_label1__61(Widget widget)
{
	...
	widget.addAttribute("id","CajaSegui:box111:label1.");
...
private void setAttrFor_label211__60(Widget widget)
{
	...
	widget.addAttribute("id","CajaSegui:box111:label211.");
...
private void setAttrFor_textfield1__61(Widget widget)
{
	...
	widget.addAttribute("name","CajaSegui:box111:textfield1.");
	widget.addAttribute("displayleft","16");
...
private void setAttrFor_textfield11__60(Widget widget)
{
	...
	widget.addAttribute("name","CajaSegui:box111:textfield11.");
...
private void setAttrFor_vpp_fecha__40(Widget widget)
{
	...
	widget.addAttribute("jsinit","window.namesToComponents['CajaSegui:vpp_fecha.'] = new NXJDatePicker('CajaSegui:vpp_fecha.', 'textfield', ' font-size: 12px; color: Black; ime-mode: disabled', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/FORMULARIOS/Login FORM PRI/Prospectoss/sources/Static_Content/', '', '', '', '', '');");
...
private void dodiv_CajaSegui__10(Widget div_CajaSegui__10)
    ...
    FieldSetWidget CajaSegui__20 = new FieldSetWidget();
        ...
        DivPanelWidget div_box111__30 = new DivPanelWidget();
            {
            ((ContainerWidget)CajaSegui__20).addComponent(div_box111__30,"div_box111_");
            ...
            FieldSetWidget box111__40 = new FieldSetWidget();
                ...
                DivPanelWidget div_label1__51 = new DivPanelWidget();
                    {
                    ((ContainerWidget)box111__40).addComponent(div_label1__51,"div_label1_");
                ...
                DivPanelWidget div_textfield1__51 = new DivPanelWidget();
                    {
                    ((ContainerWidget)box111__40).addComponent(div_textfield1__51,"div_textfield1_");
                    setAttrFor_div_textfield1__51(div_textfield1__51);
                    TextWidget textfield1__61 = new TextWidget();
                        {
                        ((ContainerWidget)div_textfield1__51).addComponent(textfield1__61,"textfield1_");
