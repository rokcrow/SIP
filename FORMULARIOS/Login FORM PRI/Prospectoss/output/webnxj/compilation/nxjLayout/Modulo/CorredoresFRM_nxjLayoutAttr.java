...
private void setAttrFor_this(Widget widget)
{
	...
	widget.addAttribute("fieldheight","496");
	widget.addAttribute("fieldwidth","1054");
...
{
	widget.addAttribute("_id","view1:(Modulo.CorredoresDVW)label11.");
        ...
        if (div_RepeatingArea1__30 != null)
            ...
            if (RepeatingArea1__40 != null)
                ...
                if (div_vco_telefono2__50 != null)
                    ...
                    div_FXGRID_50.addAttribute("jsinit","   var view1_RepeatingArea1__FXColumns = [new NXJGridColumn( 	'Codigo', 	'1', 	'1', 	'85', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_codigo', 'view1:vco_codigo.', '', ''), new NXJGridColumn( 	'Nombre', 	'1', 	'1', 	'251', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_nombre', 'view1:vco_nombre.', '', ''), new NXJGridColumn( 	'Telefono 1', 	'1', 	'1', 	'108', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_telefono1', 'view1:vco_telefono1.', '', ''), new NXJGridColumn( 	'Telefono 2', 	'1', 	'1', 	'108', 	' text-align: Left', 	new Array(), 	null, 	'textfield', 	true, 	true, 	'vco_telefono2', 'view1:vco_telefono2.', '', '') ]; ; if (!window.namesToComponents['view1_FXGRID'])     {     window.namesToComponents['view1_FXGRID'] = new NXJGrid('view1_FXGRID', view1_RepeatingArea1__FXColumns, 16, null, null, '__NXJ_CONTEXT_PATH__/unify', '', '', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/FORMULARIOS/Login FORM PRI/Prospectoss/sources/Static_Content/');     } ");
                    }
                }
            }
