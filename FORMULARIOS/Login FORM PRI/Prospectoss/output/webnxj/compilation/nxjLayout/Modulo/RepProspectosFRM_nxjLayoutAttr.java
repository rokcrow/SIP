...
{
	widget.addAttribute("_id","view1:(Modulo.RepProspectosDVW)box111.");
...
{
	widget.addAttribute("_id","view1:(Modulo.RepProspectosDVW)box111:(Modulo.RepProspectosDVW)label1.");
