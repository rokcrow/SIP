...
<%=com.unify.nxj.awebServlet.Runtime.generateToolbarOnLoad(request, 800,65)%>
</head>
...
<body onLoad="nxjOnLoad(); window.initInternalJavaScriptComponents();" class="form" >
    ...
    <form
        ...
        form_width="800"
        name="NXJForm"
        uid_prefix="ontent_toolbars_toolbar1_1260138182701"
        view="form"
        style="position:absolute; top:0px; left:0px; width:800px; height:65px">
