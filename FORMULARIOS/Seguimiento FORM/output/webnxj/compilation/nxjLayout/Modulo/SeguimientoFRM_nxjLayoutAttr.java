...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)box11.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)box11:(Modulo.SeguimientoDVW)image1.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)box111.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)box111:(Modulo.SeguimientoDVW)label211.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label10.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label11.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label11211.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label12.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label13.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label14.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label2.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label3.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label4.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label5.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label6.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label7.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label8.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)label9.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)line112.");
	widget.addAttribute("id","view1:line112.");
	widget.addStyle("overflow","hidden");
}
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)line1121.");
	widget.addAttribute("id","view1:line1121.");
	widget.addStyle("overflow","hidden");
}
...
{
	widget.addAttribute("_name","view1:(Modulo.SeguimientoDVW)vpp_ciudad.");
...
{
	widget.addAttribute("_name","view1:(Modulo.SeguimientoDVW)vpp_estadopro.");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)vpp_fecha.");
	widget.addAttribute("id","view1:vpp_fecha.");
	widget.addStyle("overflow","hidden");
	widget.suppressAttribute("name");
	widget.addAttribute("jsinclude","NXJDatePicker.js");
	widget.addAttribute("jsinit","window.namesToComponents['view1:Modulo.SeguimientoDVW;vpp_fecha.'] = new NXJDatePicker('view1:Modulo.SeguimientoDVW;vpp_fecha.', 'textfield', ' font-size: 12px; color: Black; ime-mode: disabled', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/Prospectos/sources/Static_Content/', '', '', '', '', '');");
...
{
	widget.addAttribute("_id","view1:(Modulo.SeguimientoDVW)vpp_fechaestado.");
	widget.addAttribute("id","view1:vpp_fechaestado.");
	widget.addStyle("overflow","hidden");
	widget.suppressAttribute("name");
	widget.addAttribute("jsinclude","NXJDatePicker.js");
	widget.addAttribute("jsinit","window.namesToComponents['view1:Modulo.SeguimientoDVW;vpp_fechaestado.'] = new NXJDatePicker('view1:Modulo.SeguimientoDVW;vpp_fechaestado.', 'textfield', ' font-size: 12px; color: Black; ime-mode: disabled', 'file:///C:/Unify/NXJ/web-app/unify', 'file:/C:/Users/TI3-Provivienda/Desktop/Prospectos/sources/Static_Content/', '', '', '', '', '');");
	widget.addStyle("width","165");
	widget.addStyle("height","22");
	widget.addStyle("background-color","#cccccc");
	widget.addStyle("foreground-color","Black");
...
{
	widget.addAttribute("_name","view1:(Modulo.SeguimientoDVW)vpp_nacionalidad.");
...
private void dodiv_view1__10(Widget div_view1__10)
    ...
    nxjLayout.Modulo.SeguimientoDVW_nxjLayoutAttr view1__20 = new nxjLayout.Modulo.SeguimientoDVW_nxjLayoutAttr();
        {
        ...
        Widget div_line112__30 = ((ContainerWidget)view1__20).getComponent("div_line112_");
        if (div_line112__30 != null)
            {
            setAttrFor_div_line112__30(div_line112__30);
            Widget line112__40 = ((ContainerWidget)div_line112__30).getComponent("line112_");
            if (line112__40 != null)
                {
                setAttrFor_line112__40(line112__40);
                }
            }
        Widget div_line1121__30 = ((ContainerWidget)view1__20).getComponent("div_line1121_");
        if (div_line1121__30 != null)
            {
            setAttrFor_div_line1121__30(div_line1121__30);
            Widget line1121__40 = ((ContainerWidget)div_line1121__30).getComponent("line1121_");
            if (line1121__40 != null)
                {
