...
public class ProspectosFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private ProspectosFRM ProspectosFRM = this;
    public class view1
	...
	public void beforeFind()
	    throws Exception
	{
	    getSession().displayToMessageBox("Koala");
	} // beforeFind
    ...
    public ProspectosFRM(NXJSession session, NXJForm prevForm)
    {
	super("ProspectosFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected ProspectosFRM(String formName, NXJSession session, NXJForm prevForm)
    {
    ...
    public static final String menuLabel = "ProspectosFRM";
} // ProspectosFRM
