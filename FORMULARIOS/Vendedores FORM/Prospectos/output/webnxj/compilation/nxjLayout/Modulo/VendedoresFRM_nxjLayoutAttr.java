...
{
	widget.addAttribute("displaywidth","1205");
	widget.addAttribute("stylesheets","");
	widget.addAttribute("displayheight","842");
	widget.addAttribute("fieldheight","842");
	widget.addAttribute("fieldwidth","1205");
