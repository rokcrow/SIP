...
{
	widget.addAttribute("labeltitle","NewLabel");
	widget.addStyle("font-weight","bold");
	widget.addAttribute("displaywidth","300");
	widget.addAttribute("id","cajagrandeLogin:label2.");
	widget.addAttribute("displayleft","50");
	widget.addAttribute("displaytop","163");
	widget.addAttribute("displayheight","18");
	widget.addAttribute("fieldheight","18");
...
private void dodiv_cajagrandeLogin__10(Widget div_cajagrandeLogin__10)
    ...
    FieldSetWidget cajagrandeLogin__20 = new FieldSetWidget();
        ...
        DivPanelWidget div_label2__30 = new DivPanelWidget();
            {
            ((ContainerWidget)cajagrandeLogin__20).addComponent(div_label2__30,"div_label2_");
