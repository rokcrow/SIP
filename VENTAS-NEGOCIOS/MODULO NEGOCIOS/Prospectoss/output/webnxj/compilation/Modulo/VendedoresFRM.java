...
public class VendedoresFRM
    extends com.unify.nxj.mgr.NXJForm
{
    private VendedoresFRM VendedoresFRM = this;
    public class view1
	extends Modulo.VendedoresDVW
    {
    ...
    public VendedoresFRM(NXJSession session, NXJForm prevForm)
    {
	super("VendedoresFRM", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected VendedoresFRM(String formName, NXJSession session, NXJForm prevForm)
    {
	...
	setZoomReturnExpressions(new NXJZoomReturnExpressions()
	{
		...
		return new com.unify.nxj.mgr.datatypes.Register[]
		    {
		    us$registerPool.allocateRegister().load(view1.vvh_vendedora)
		    };
	    } // evaluate
    ...
    public static final String menuLabel = "VendedoresFRM";
} // VendedoresFRM
