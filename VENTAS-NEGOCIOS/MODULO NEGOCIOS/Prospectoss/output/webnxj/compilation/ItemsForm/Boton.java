...
public class Boton
    extends com.unify.nxj.mgr.datatypes.NXJButtonImpl
{
    private Boton Boton = this;

    public Boton(com.unify.nxj.mgr.NXJContainer container, String controlName, boolean isMultiValued)
    {
	super(container, controlName, isMultiValued);
	setStyleClass("button");
	setForegroundColor("White");
	setBackgroundColor("#e30000");
