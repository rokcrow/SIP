    ...
    extends com.unify.nxj.mgr.NXJForm
{
	...
	box1.xxx.assign(us$registerPool.allocateRegister().load("3"));
	getSession().displayToMessageBox(us$registerPool.allocateRegister().load(box1.xxx).getStringValue());
	((ModuloCNegocios.RBoletinesFRM)us$findForm(ModuloCNegocios.RBoletinesFRM.class)).cajagrandeRBoletines.number.assign(us$registerPool.allocateRegister().load(box1.xxx));
    } // beforeForm
    private Form3 Form3 = this;
    public class box1
    ...
    public Form3(NXJSession session, NXJForm prevForm)
    {
	super("Form3", session, prevForm);
	us$initializeFormSpecificProperties();
    } // <init>

    protected Form3(String formName, NXJSession session, NXJForm prevForm)
    {
    ...
    public static final String menuLabel = "Form3";
} // Form3
