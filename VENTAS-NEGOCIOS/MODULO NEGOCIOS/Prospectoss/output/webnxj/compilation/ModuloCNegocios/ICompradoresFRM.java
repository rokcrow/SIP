    ...
    extends com.unify.nxj.mgr.NXJForm
{
	...
	((ModuloCNegocios.RBoletinesFRM)us$findForm(ModuloCNegocios.RBoletinesFRM.class)).cajagrandeRBoletines.varpass1.assign(us$registerPool.allocateRegister().load("1"));
    } // beforeForm
	...
	vmu_garage1.us$setCandidateTargetColumnName("vuu_etapa");
