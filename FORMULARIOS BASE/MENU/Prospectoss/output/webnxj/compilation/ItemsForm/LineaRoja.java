...
public class LineaRoja
    extends com.unify.nxj.mgr.datatypes.NXJLineImpl
{
    private LineaRoja LineaRoja = this;

    public LineaRoja(com.unify.nxj.mgr.NXJContainer container, String controlName, boolean isMultiValued)
    {
	super(container, controlName, isMultiValued);
	setStyleClass("horizontal_line");
